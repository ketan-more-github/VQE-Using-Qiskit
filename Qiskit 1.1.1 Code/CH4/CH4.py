...
molecule = MoleculeInfo(
        ...
        symbols=["C", "H" , "H", "H" , "H"],
        coords=([0.0, 0.0, 0.0], [0.6252760	, 0.6252760	 , 0.6252760] ,[-0.6252760 , -0.6252760 ,0.6252760] , [-0.6252760 , 0.6252760 , -0.6252760],[0.6252760 , -0.6252760 , -0.6252760]),
...
problem = FreezeCoreTransformer(
    freeze_core=True, remove_orbitals=[6,7,8,9]
...
print(f"Number of qubits = {var_form.num_qubits}")
...
with Session(backend=backend) as session:
    ...
    estimator.options.default_shots = 2000 #4096
...
# Iters. done: 579 [Current cost: -19.08109064807428]
# Iters. done: 580 [Current cost: -19.07641548977454]
# Iters. done: 581 [Current cost: -19.113348392202404]
# Iters. done: 582 [Current cost: -19.1823228116313]
# Iters. done: 583 [Current cost: -19.24883173356962]
#  message: Optimization terminated successfully.
#  success: True
#   status: 1
#      fun: -19.24883173356962
#        x: [ 1.367e+00  2.948e+00 ...  2.076e+00  2.286e+00]
#     nfev: 583
#    maxcv: 0.0

# === GROUND STATE ENERGY ===
 
# * Electronic ground state energy (Hartree): -67.022984748152
#   - computed part:      -19.24883173357
#   - FreezeCoreTransformer extracted energy part: -47.774153014582
# ~ Nuclear repulsion energy (Hartree): 14.033695679786
# > Total ground state energy (Hartree): -52.989289068366
...
# calculting using numpy
# === GROUND STATE ENERGY ===
 
# * Electronic ground state energy (Hartree): -69.770627941648
#   - computed part:      -21.996474927066
#   - FreezeCoreTransformer extracted energy part: -47.774153014582
# ~ Nuclear repulsion energy (Hartree): 14.033695679786
# > Total ground state energy (Hartree): -55.736932261862
